...
Rinf_Table=tabularTextDatastore('Antarctica_Landsat8_Rinf_2014_2019.csv','TreatAsMissing','NA','MissingValue',0);
...
for scene = 1:size(Scenes,1)
   ...
   %%%%% Depth Calculation using Band 8: Panchromatic Band
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   mask=lake_mask;
   image=B8; 
